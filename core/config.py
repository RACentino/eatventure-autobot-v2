...
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.070
...
AI_LEARNING_APPLY_COOLDOWN = 15.0
...
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.015

# Maximum search interval allowed by historical learning.
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.070
