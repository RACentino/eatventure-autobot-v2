...
SCRCPY_RED_ICON_MISS_RECOVERY_DELAY = 0.055
SCRCPY_BOX_MISS_RECOVERY_DELAY = 0.055
SCRCPY_UPGRADE_MISS_RECOVERY_DELAY = 0.065
...
CLICK_DELAY = 0.045
MOUSE_MOVE_DELAY = 0.045
MOUSE_DOWN_DURATION = 0.050
MOUSE_UP_DURATION = 0.025
HOVER_ENABLED = True
HOVER_DURATION = 0.016
UPGRADE_SEARCH_INTERVAL = 0.055
STATE_DELAY = 0.055
UPGRADE_STATION_VERIFY_SETTLE_DELAY = 0.085
UPGRADE_STATION_VERIFY_SEARCH_ATTEMPTS = 5
UPGRADE_STATION_VERIFY_SEARCH_INTERVAL = 0.045
...
SCROLL_INTERVAL_PAUSE = 0.0150
POST_SCROLL_SETTLE = 0.0150
...
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.090
...
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.090
