...
SCRCPY_BOX_MISS_RECOVERY_DELAY = 0.070
...
HOVER_ENABLED = True
HOVER_DURATION = 0.010
UPGRADE_SEARCH_INTERVAL = 0.105
STATE_DELAY = 0.095
...
STATS_UPGRADE_CLICK_DURATION = 0.95
...
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.080
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.140
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.006
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.025
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.090
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.240
...
AI_LEARNING_MIN_CLICK_DELAY = 0.080
AI_LEARNING_MAX_CLICK_DELAY = 0.140
AI_LEARNING_MIN_MOVE_DELAY = 0.006
AI_LEARNING_MAX_MOVE_DELAY = 0.025
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.090
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.240
