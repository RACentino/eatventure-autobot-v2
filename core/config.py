...
SCRCPY_RED_ICON_MISS_RECOVERY_DELAY = 0.125
SCRCPY_BOX_MISS_RECOVERY_DELAY = 0.120
SCRCPY_UPGRADE_MISS_RECOVERY_DELAY = 0.145
...
CLICK_DELAY = 0.112
MOUSE_MOVE_DELAY = 0.012
MOUSE_DOWN_DURATION = 0.048
MOUSE_UP_DURATION = 0.038
HOVER_ENABLED = True
HOVER_DURATION = 0.015
UPGRADE_SEARCH_INTERVAL = 0.130
STATE_DELAY = 0.140
...
STATS_UPGRADE_CLICK_DELAY = 0.028
...
ADAPTIVE_TUNER_SEARCH_DECREMENT = 0.0035
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.100
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.160
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.010
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.026
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.115
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.235
...
AI_LEARNING_APPLY_COOLDOWN = 36.0
AI_LEARNING_MIN_CLICK_DELAY = 0.100
AI_LEARNING_MAX_CLICK_DELAY = 0.160
AI_LEARNING_MIN_MOVE_DELAY = 0.010
AI_LEARNING_MAX_MOVE_DELAY = 0.026
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.115
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.235
LEARNING_LOOP_MIN_SLEEP = 1.25
