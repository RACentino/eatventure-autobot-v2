...
SCRCPY_BOX_MISS_RECOVERY_DELAY = 0.14

# Retry delay after an upgrade station scan miss.
SCRCPY_UPGRADE_MISS_RECOVERY_DELAY = 0.10
...
LEVEL_TRANSITION_CONFIRM_DELAY = 0.80

# Delay after the level transition animation completes.
LEVEL_TRANSITION_COMPLETE_DELAY = 1.40
...
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.160
...
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.180
...
AI_LEARNING_MAX_CLICK_DELAY = 0.160
...
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.180
