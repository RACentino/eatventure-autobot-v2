...
SCRCPY_RED_ICON_MISS_RECOVERY_DELAY = 0.105
SCRCPY_BOX_MISS_RECOVERY_DELAY = 0.100
SCRCPY_UPGRADE_MISS_RECOVERY_DELAY = 0.120
...
SPAM_CLICK_DURATION = 0.95
SPAM_CLICK_DELAY = 0.050
...
AI_LEARNING_THREAD_JOIN_TIMEOUT = 0.90
AI_LEARNING_THREAD_INTERVAL = 1.10
...
AI_LEARNING_MIN_CLICK_DELAY = 0.095
AI_LEARNING_MAX_CLICK_DELAY = 0.150
AI_LEARNING_MIN_MOVE_DELAY = 0.008
AI_LEARNING_MAX_MOVE_DELAY = 0.024
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.105
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.220
LEARNING_LOOP_MIN_SLEEP = 1.10
