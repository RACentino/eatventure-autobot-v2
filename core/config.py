...
SCRCPY_RED_ICON_MISS_RECOVERY_DELAY = 0.35

# Retry delay after a box scan miss.
SCRCPY_BOX_MISS_RECOVERY_DELAY = 0.30

# Retry delay after an upgrade station scan miss.
SCRCPY_UPGRADE_MISS_RECOVERY_DELAY = 0.45
...
UPGRADE_STATION_VERIFY_SEARCH_INTERVAL = 0.35


UPGRADE_STATION_HOLD_CHECK_INTERVAL = 0.24
...
ADAPTIVE_TUNER_CLICK_DELAY_STEP = 0.035
...
ADAPTIVE_TUNER_SEARCH_INTERVAL_STEP = 0.040
...
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.30

# Maximum click delay allowed by adaptive tuning.
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.55

# Minimum move delay allowed by adaptive tuning.
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.10
