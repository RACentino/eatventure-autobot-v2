...
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.32

# Minimum move delay allowed by adaptive tuning.
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.07
...
AI_LEARNING_MAX_CLICK_DELAY = 0.32

# Minimum move delay allowed by historical learning.
AI_LEARNING_MIN_MOVE_DELAY = 0.07
