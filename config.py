...
ASSET_TRACKING_INTERVAL = 0.0

# Maximum age in seconds for tracker snapshots used by bot actions.
ASSET_TRACKING_MAX_SNAPSHOT_AGE = 0.100
...
SCRCPY_RED_ICON_MISS_RECOVERY_DELAY = 0.033
...
UPGRADE_STATION_VERIFY_SEARCH_INTERVAL = 0.0800
...
STATS_UPGRADE_CLICK_DELAY = 0.033
...
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.033

# Maximum move delay allowed by adaptive tuning.
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.150
...
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.200
...
AI_LEARNING_MIN_MOVE_DELAY = 0.033

# Maximum move delay allowed by historical learning.
AI_LEARNING_MAX_MOVE_DELAY = 0.150
...
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.200
